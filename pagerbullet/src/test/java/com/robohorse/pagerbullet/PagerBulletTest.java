...
public class PagerBulletTest {
    ...
    public void testDotsVisibility() {
        ...
        pagerBullet.setAdapter(new PagerAdapterTest(activity, dotsCount));
    ...
    public void testGetCurrentItem() {
        pagerBullet.setAdapter(new PagerAdapterTest(activity, 10));
    ...
    public void testSetCurrentItem() {
        ...
        spy.setAdapter(new PagerAdapterTest(activity, 10));
